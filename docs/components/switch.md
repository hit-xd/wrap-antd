...
```tsx
import { ConfigProvider, Switch, Space, Card, Typography } from 'privatebank-design';
...
```tsx
import { ConfigProvider, Switch, Space, Card } from 'privatebank-design';
...
```tsx
import { ConfigProvider, Switch, Space, Button, Form } from 'privatebank-design';
