...
```tsx
import { ConfigProvider, Progress, Space } from 'privatebank-design';
...
```tsx
import { ConfigProvider, Progress, Space, Card, Typography } from 'privatebank-design';
...
```tsx
import { ConfigProvider, Progress, Space, Card } from 'privatebank-design';
...
```tsx | pure
import type { ProgressProps } from 'privatebank-design';
```
