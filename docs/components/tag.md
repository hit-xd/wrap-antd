...
```tsx
import { ConfigProvider, Tag, Space, Card, Typography } from 'privatebank-design';
...
```tsx
import { ConfigProvider, Tag, Space, Card } from 'privatebank-design';
...
```tsx
import { ConfigProvider, Tag, Space, List } from 'privatebank-design';
