...
```tsx
import { ConfigProvider, Popover, Space, Button, Card, Typography } from 'privatebank-design';
...
```tsx
import { ConfigProvider, Popover, Space, Button, List } from 'privatebank-design';
